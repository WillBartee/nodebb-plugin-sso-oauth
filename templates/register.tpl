...
<div class="row register">
    <!-- This block is hidden to prevent users from registering directly with NodeBB -->
  <div class="hidden">
  <div class="{register_window:spansize}">
	...
	<div class="col-md-6">
        ...
        <h4>Register with NOVA<h4>
  			<ul class="alt-logins">
  				<!-- BEGIN authentication -->
  				<li class="{authentication.name}">
            <a rel="nofollow noopener noreferrer" target="_top" href="{authentication.registerURL}">
              <div><img src="{authentication.icon}" class="fa fa-3x"/></div>
              <div>{authentication.linktext}</div>
          </a>
        </li>
  				<!-- END authentication -->
  			</ul>
